        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#brand">
                    ...
                    <img src="<?= base_url('assets/'); ?>assets/img/kemenag_logo.png" class="logo" alt="logo">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="button-holder">
                        ...
                        <button type="button" class="btn btn-blue navbar-btn">Contact us</button>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 caption">
                    ...
                    <h1>Welcome To MAN 3 KARAWANG</h1>
                    ...
                    <a href="<?= base_url('auth'); ?>" class="btn btn-transparent">Sign in here</a>
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <form class="signup-form" method="post" action="<?= base_url('auth/registration'); ?>">
                        ...
                        <div class="form-group text-center">
                            ...
                            <button type="submit" class="btn btn-blue btn-block">Registration</button>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-push-2">
                    ...
                    <img src="<?= base_url('assets/'); ?>assets/img/dashboard.png" class="img-responsive" alt="feature">
            ...
            <div class="row">
                ...
                <div class="clients-images">
                    ...
                    <div id="owl-clients">
                        ...
                        <div class="item"><img src="<?= base_url('assets/'); ?>assets/img/clients/c_logo01.png" class="center-block" alt="client"></div>

                        <div class="item"><img src="<?= base_url('assets/'); ?>assets/img/clients/c_logo02.png" class="center-block" alt="client"></div>

                        <div class="item"><img src="<?= base_url('assets/'); ?>assets/img/clients/c_logo03.png" class="center-block" alt="client"></div>

                        <div class="item"><img src="<?= base_url('assets/'); ?>assets/img/clients/c_logo04.png" class="center-block" alt="client"></div>

                        <div class="item"><img src="<?= base_url('assets/'); ?>assets/img/clients/c_logo05.png" class="center-block" alt="client"></div>

                        <div class="item"><img src="<?= base_url('assets/'); ?>assets/img/clients/c_logo06.png" class="center-block" alt="client"></div>
